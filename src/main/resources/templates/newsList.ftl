...
<div id="wp" class="wp">
    <div id="pt" class="bm cl">
        <div class="z">
            ...
            <#if pageInfo.type!=0>
                <em>›</em>
                <a href="${base}/news-${pageInfo.type}-1.html">
                    <@dict_tag type="news_type" value="${pageInfo.type}">
                        <a href="${base}/news-${pageInfo.type}-1.html">${dict.label}</a>
                    </@dict_tag>
                </a>
            </#if>
        </div>
    ...
    <div class="container clearfix">
        <nav class="clearfix col-1" id="nav">
            <div class="nav_com">
                <ul>
                    <li class="<#if pageInfo.type==0>active</#if>"><a href="${base}/news">最新</a></li>
                    <li class=""><a href="${base}/news">关注</a></li>
                    <@dict_tag type="news_type">
                        <#list dictList as dict>
                            <li class="<#if pageInfo.type==dict.value>active</#if>"><a href="${base}/news-${dict.value}-1.html">${dict.label}</a></li>
                        </#list>
                    </@dict_tag>
                </ul>
            </div>
